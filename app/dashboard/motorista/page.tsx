...
export default function MotoristaDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center font-sans antialiased text-slate-900 p-0 sm:p-6 md:p-8">
      <style jsx global>{`
      ...
      <div className="w-full max-w-md bg-slate-50 sm:shadow-[0_24px_64px_rgba(0,0,0,0.1)] flex flex-col relative min-h-screen sm:min-h-[840px] sm:rounded-[36px] overflow-hidden border border-slate-200">
        ...
        <main className="relative z-10 pt-32 px-5 pb-32 overflow-y-auto flex-1 scrollbar-thin">
