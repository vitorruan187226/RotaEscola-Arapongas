...
export default function MotoristaDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f7fafc] font-sans antialiased text-[#181c1e] p-0 sm:p-6 md:p-8 relative overflow-hidden flex items-center justify-center">
      <style jsx global>{`
        .glass {
      ...
      <div className="w-full max-w-md bg-transparent mx-auto sm:shadow-[0_24px_64px_rgba(0,0,0,0.1)] flex flex-col relative min-h-screen sm:min-h-[840px] sm:rounded-[36px] overflow-hidden border border-slate-200/50">
        ...
        <header className="absolute top-6 left-1/2 -translate-x-1/2 w-[90%] max-w-lg z-40">
          <div className="glass rounded-full px-6 py-3 flex justify-between items-center shadow-lg">
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-10 h-10 rounded-full border-2 border-white overflow-hidden shadow-sm shrink-0 flex items-center justify-center bg-white"
            ...
            <div className="flex items-center gap-2">
              <button onClick={handleLogout} title="Sair do Sistema" className="w-10 h-10 flex items-center justify-center rounded-full bg-white/50 hover:bg-white text-[#002045] shadow-sm transition-all active:scale-95">
                <LogOut size={18} />
              </button>
            </div>
          </div>
        ...
        <main className="flex-1 overflow-y-auto px-5 pt-24 pb-36 scrollbar-thin relative z-10 flex flex-col gap-6">
