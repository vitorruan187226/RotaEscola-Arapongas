            ...
            <div className="flex flex-col gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-3 rounded-xl border border-slate-200 text-xs font-bold text-slate-800 placeholder-slate-400 focus:outline-none focus:border-amber-500 transition-all"
                />
                <div className="mt-3 bg-slate-50 border border-slate-100 rounded-xl p-3 flex flex-col gap-1">
                  <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Mapeamento de Ponto de Embarque</span>
                  {latitude && longitude ? (
                    <span className="text-xs text-emerald-600 font-bold flex items-center gap-1">
                      ✅ Localização validada para cálculo do ponto
                    </span>
                  ) : (
                    <span className="text-xs text-amber-500 font-bold flex items-center gap-1">
                      ⚠️ Clique em "Auto-preencher" para validar o endereço
                    </span>
                  )}
                </div>
              </div>
